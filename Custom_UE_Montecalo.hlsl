...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
    ...
    MaterialFloat4 Local0 = SceneTextureLookup(GetDefaultSceneTextureUV(Parameters, 1), 1, false);
    MaterialFloat4 Local1 = (Local0.rgba + 451233.00000000);
    MaterialFloat3 Local2 = lerp(Local1.rgb, Material.VectorExpressions[1].rgb, MaterialFloat(Material.ScalarExpressions[0].x));
